                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="D_id" class="form-control" required="true" placeholder="Enter ID..."/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="degree" required="true" class="form-control" placeholder="Enter Home Degree..."/>
                                </div>
                            </div>
                            <!-- /.box-body -->
