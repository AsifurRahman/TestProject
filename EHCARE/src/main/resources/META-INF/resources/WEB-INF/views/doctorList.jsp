                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="doctorTable" class="table table-striped">
                                            ...
                                            <tbody>
                                            <c:forEach items="${doctorList}" var="dt" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>${dt.email}</td>
                                                    <td>
                                                        <a class="btn btn-warning btn-sm" href="./upsertDoctor?doctorId=${pt.id}">Update</a>
                                                        <a class="btn btn-danger btn-sm" href="./deleteDoctor?doctorId=${pt.id}">Delete</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
